...
<body>
    <form action="validate.php" method="post" autocomplet="off">
<div class="container">
  <div class="left">
    <div class="header">
    ...
    <div class="form">
      <input type="text" class="form-field animation a3" name="username" placeholder="Username">
